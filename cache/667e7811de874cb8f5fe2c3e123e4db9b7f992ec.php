                    ...
                    <?php else: ?>    
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="10%"><input type="checkbox" id="dept-<?php echo e($i); ?>" name="departments[<?php echo e($i); ?>][dept_id]" value="<?php echo e($w['ID']); ?>" <?php echo e((in_array($w['ID'], $mapped_depts['dept_id']) ? ' checked="" ' : '' )); ?> ></td>
                                    <td width="10%"><input type="checkbox" id="mail-<?php echo e($i); ?>" name="departments[<?php echo e($i); ?>][send_mail]" value="1" <?php echo e((in_array($w['ID'], $mapped_depts['send_mail']) ? ' checked="" ' : '' )); ?> ></td>
...
<?php echo $__env->make('cpanel.cpanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shan/www/tth/attendance-portal/views/cpanel/users/edit.blade.php ENDPATH**/ ?>