...
<form action="/cashiers/update/<?php echo e($cashier['ID']); ?>" class="HFForm" method="post" data-na="success-then-redirect-to-next-screen" data-ns="/cashiers">
    <h5>Edit Cashier</h5>
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default color-palette-box">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter staff full name" autocomplete="off" value="<?php echo e($cashier['name']); ?>" >
                    </div>

                    <div class="form-group">
                        <label class="col-form-label" for="username">Username</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Active Directory Username" autocomplete="off" value="<?php echo e($cashier['username']); ?>" >
                    </div>

                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" value="1" <?php echo e(( $cashier['isActive'] ? ' checked ' : '' )); ?> id="isActive" name="isActive">
                        ...
                        <?php $__currentLoopData = $workstations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ws): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <table class="table table-bordered">
                                ...
                                <?php $__currentLoopData = $ws['workstations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wrkstns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><input <?php echo e(( in_array($wrkstns['ID'], $cashier['workstations']) ? ' checked ' : '')); ?> type="checkbox" name="workstations[]" value="<?php echo e($wrkstns['ID']); ?>" class="child-id-<?php echo e($ws['ID']); ?>" value="<?php echo e($wrkstns['ID']); ?>"></td>
...
<?php echo $__env->make('cpanel.cpanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shan/www/tth/tth-cashdrawers/views/cpanel/cashiers/edit.blade.php ENDPATH**/ ?>