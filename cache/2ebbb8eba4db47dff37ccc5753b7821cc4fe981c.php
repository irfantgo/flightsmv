...
<?php echo $__env->make('cpanel.attendance.controls', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-body">
                <a href="/department/genpdf/<?php echo e($department['ID']); ?>/payroll" target="_blank" class="btn btn-default">Generate PDF</a>
            </div>
        </div>
...
<?php echo $__env->make('cpanel.cpanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shan/www/tth/attendance-portal/views/cpanel/attendance/payroll.blade.php ENDPATH**/ ?>